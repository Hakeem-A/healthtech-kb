...
Revision ID: fb58dc435f2d
Revises: 
Create Date: 2026-07-23 11:18:40.109878
...
def upgrade() -> None:
    ...
    sa.ForeignKeyConstraint(['parent_id'], ['categories.id'], onupdate='CASCADE', ondelete='SET NULL'),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    sa.Column('widget_source', sa.String(), nullable=True),
    sa.Column('created_at', sa.DateTime(), nullable=True),
